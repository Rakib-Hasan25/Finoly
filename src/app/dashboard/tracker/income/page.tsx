...
export default function IncomePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h1 className="text-3xl font-bold text-gray-900">Monthly Income Tracker</h1>
        <p className="text-gray-600">Track your income streams and monitor your financial growth</p>
        ...
        <motion.div
          ...
          className="inline-flex items-center space-x-2 px-6 py-3 bg-green-50 rounded-full"
        >
                  ...
                  {monthlyTransactions
                    ...
                    .map((transaction, index) => (
                      <motion.div
                        ...
                        className="flex items-center justify-between p-4 rounded-lg border border-gray-100 hover:shadow-md transition-all"
                      >
