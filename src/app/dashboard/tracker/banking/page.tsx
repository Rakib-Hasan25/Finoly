...
export default function BankingPage() {
  ...
  useEffect(() => {
    const loadAccounts = () => {
      // @ts-ignore: Suppress error for storage.getBankAccounts()
    ...
    <div className="space-y-8 max-w-full overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-300">
          Manage your accounts and track your net worth
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <Card
            className={`bg-gradient-to-br border-2 backdrop-blur-sm ${
              netWorth >= 0
                ...
                <div>
                  <p
                    className={`text-sm font-medium ${
                      netWorth >= 0 ? "text-blue-300" : "text-orange-300"
                    }`}
                  >
                    Net Worth
                  </p>
            ...
            <FloatingCard className="bg-slate-800/50 border-slate-700/50 backdrop-blur-sm">
              <div className="text-center py-12">
                ...
                <p className="text-gray-300 mb-4">
                  Add your bank accounts to track your complete financial
                  picture.
                </p>
                <Button
                  onClick={() => setShowAccountForm(true)}
