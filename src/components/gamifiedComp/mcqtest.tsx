...
export default function TestPage({ id, setTest, cards }: Test) {
          ...
          {currentIndex < cards.length ? (
            ...
            >
              ...
              <motion.div variants={cardVariants} className="space-y-3 mb-4">
                {cards[currentIndex].options.map((option, i) => (
                  <motion.label
                    key={i}
            ...
            >
              ...
              <p className="text-xl mb-4">
                ...
                {Math.round((score / (cards.length * 10)) * 100)}%)
              </p>
